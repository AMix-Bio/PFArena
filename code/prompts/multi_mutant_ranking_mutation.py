"""
    T4: Mutation-informed multi-mutant ranking
    @single_mutant_dms_scores format: "\n".join(List[<mutant>: <dms_score>])
"""
def multi_mutant_ranking_mutation_template():
    prompt = \
"""
...
2. **Multi-Mutation Candidates**: A candidate contains multiple mutations joined by + (e.g., K23A+A40P+T52S). When ranking multi-mutation candidates, account for their combined effects.
